...
from app.schemas.schemas import NewsResponse, QuoteResponse, StockPriceSchema, StockSchema
...
async def get_company_profile(
    symbol: str = Query(..., description="Stock Ticker Symbol"), db: AsyncSession = Depends(get_db)
):
